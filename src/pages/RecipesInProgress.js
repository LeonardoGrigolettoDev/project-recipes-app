...
// import loadRecipe from '../services/fetchRecipeInProgress';
      ...
      {teste.map((elem) => (
        ...
        >
          ...
          <ol>
            ...
            <li>{elem.strIngredient6}</li>
            <li>{elem.strIngredient7}</li>
            <li>{elem.strIngredient8}</li>
            <li>{elem.strIngredient9}</li>
            <li>{elem.strIngredient10}</li>
            <li>{elem.strIngredient11}</li>
            <li>{elem.strIngredient12}</li>
            <li>{elem.strIngredient13}</li>
            <li>{elem.strIngredient14}</li>
            <li>{elem.strIngredient15}</li>
            <li>{elem.strIngredient16}</li>
            <li>{elem.strIngredient17}</li>
            <li>{elem.strIngredient18}</li>
            <li>{elem.strIngredient19}</li>
            <li>{elem.strIngredient20}</li>
          </ol>
          <span
